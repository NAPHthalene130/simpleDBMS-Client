...
void NetSender::start()
{
    ...
    serviceThread = std::thread(&NetSender::processQueue, this);
}
...
void NetSender::sendMessage(const std::string &message,
                            ...
                            unsigned short targetPort)
{
...

    {
        ...
        pendingMessages.push(PendingMessage{message, targetAddress, targetPort});
    }

    conditionVariable.notify_one();
}

void NetSender::processQueue()
{
